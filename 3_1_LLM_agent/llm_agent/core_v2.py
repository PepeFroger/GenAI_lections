...
from .tool_randomuser import RandomUserTool
...
class LLMAgent:
    ...
    def _ask_llm_for_plan(self, query: str) -> List[Dict]:
        ...
        - **random_user**: For generating a random user profile (name, email, address, phone, etc.). Use it with a description of the desired user parameters (e.g., nationality, gender, count) or an empty string for default random data.
